...
cases('identifiers', opts => {
  ...
  kinds: ['a:binding', 'b:static', 'c:binding', 'd:reference'],
  grammars: ['a:javascript', 'b:javascript', 'c:javascript', 'd:javascript'],
}, {
  name: 'function arg object pattern',
  plugins: ['flow'],
  code: 'function a([b] = c) {}',
  ...
  kinds: ['a:binding', 'b:static', 'c:static', 'd:static', 'd:binding', 'e:reference'],
  grammars: ['a:javascript', 'b:javascript', 'c:javascript', 'd:javascript', 'd:javascript', 'e:javascript'],
}, {
